...
const messages = {
  en: {
    ...
    gamesHeading: "Games",
    gamesIntro: "Choose a challenge and practice at your own pace.",
    openGameAria: "Open {name}",
  ...
  es: {
    ...
    gamesHeading: "Juegos",
    gamesIntro: "Elige un reto y practica a tu propio ritmo.",
    openGameAria: "Abrir {name}",
