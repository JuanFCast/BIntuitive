...
const messages = {
  en: {
    ...
    wordIntro: "Put the letters in order to build the word.",
    wordHowTo: "Look at the picture and tap the letters one by one. Use the arrow to take a letter back.",
    wordStart: "Start puzzle",
    wordInstruction: "Tap the letters in order",
    wordProgressAria: "Word {current} of {total}",
    wordLevel: "Level",
    wordLevelAria: "Difficulty level {level} of {total}",
    wordListen: "Listen to the word",
    wordAnswerAria: "Your word: {word}",
    wordEmptyAnswer: "no letters yet",
    wordLettersAria: "Available letters",
    wordLetterAria: "Letter {letter}",
    wordUndo: "Take back the last letter",
    wordClear: "Clear the word",
    wordPerfectWords: "Perfect words",
    wordMistakes: "Mistakes",
    wordAccuracy: "Accuracy",
    wordResultsTitle: "Puzzle complete!",
    wordResultsText: "You built all {total} words.",
    wordRecord: "🏆 New record!",
    wordPlayAgain: "Play again",
  },
  es: {
    ...
    wordTitle: "Word Puzzle",
    wordIntro: "Ordena las letras para formar la palabra.",
    wordHowTo: "Mira la imagen y toca las letras una por una. Usa la flecha para devolver una letra.",
    wordStart: "Empezar reto",
    wordInstruction: "Toca las letras en orden",
    wordProgressAria: "Palabra {current} de {total}",
    wordLevel: "Nivel",
    wordLevelAria: "Nivel de dificultad {level} de {total}",
    wordListen: "Escuchar la palabra",
    wordAnswerAria: "Tu palabra: {word}",
    wordEmptyAnswer: "todavía sin letras",
    wordLettersAria: "Letras disponibles",
    wordLetterAria: "Letra {letter}",
    wordUndo: "Devolver la última letra",
    wordClear: "Borrar la palabra",
    wordPerfectWords: "Palabras perfectas",
    wordMistakes: "Errores",
    wordAccuracy: "Precisión",
    wordResultsTitle: "¡Reto terminado!",
    wordResultsText: "Formaste las {total} palabras.",
    wordRecord: "🏆 ¡Nuevo récord!",
    wordPlayAgain: "Jugar otra vez",
  },
} as const;
