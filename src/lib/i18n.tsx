...
const messages = {
  en: {
    ...
    tracingPickLevel: "Choose a level",
    tracingLevelOption: "Level {level}",
    tracingLevelUnlockedAria: "Level {level}, unlocked",
    tracingLevelSelectedAria: "Level {level}, chosen",
    tracingLevelLockedAria: "Level {level}, locked",
    tracingLevelLockedHint:
      "Finish level {level} with 2 stars to open level {next}.",
    tracingExerciseStars: "Trace stars",
    tracingSessionStars: "Session stars",
    tracingSessionStarsAria: "{stars} out of 3 session stars",
    tracingUnlockedLevel: "You opened level {level}! 🎉",
    tracingLevelBest: "Best so far: level {level} of {total}",
  ...
  es: {
    ...
    tracingPickLevel: "Elige un nivel",
    tracingLevelOption: "Nivel {level}",
    tracingLevelUnlockedAria: "Nivel {level}, desbloqueado",
    tracingLevelSelectedAria: "Nivel {level}, elegido",
    tracingLevelLockedAria: "Nivel {level}, bloqueado",
    tracingLevelLockedHint:
      "Termina el nivel {level} con 2 estrellas para abrir el nivel {next}.",
    tracingExerciseStars: "Estrellas de trazos",
    tracingSessionStars: "Estrellas de la sesión",
    tracingSessionStarsAria: "{stars} de 3 estrellas de la sesión",
    tracingUnlockedLevel: "¡Has abierto el nivel {level}! 🎉",
    tracingLevelBest: "Tu mejor nivel: {level} de {total}",
